...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> error(String error, String message, String path, String requestId, Object details) {
        return new ApiResponse<>(false, error, message, null, details instanceof Map ? (Map<String, Object>) details : null, path, requestId);
    }
